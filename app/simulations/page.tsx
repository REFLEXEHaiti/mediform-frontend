// app/simulations/page.tsx — MediForm Haiti
// ⚠️ EXCLUSIF À MEDIFORM HAITI — module unique, absent de LexHaiti et TechPro
// Simulations cliniques générées par l'IA médicale
...
const CAS_TYPES = [
  { id: 'urgence',    label: 'Urgences médicales',     description: 'Traumatismes, arrêt cardiaque, choc anaphylactique, AVC…',         icone: '🚨', couleur: '#DC2626' },
  { id: 'maternite',  label: 'Maternité & Obstétrique', description: 'Accouchements, complications, hémorragie post-partum, prééclampsie…', icone: '👶', couleur: BLEU },
  { id: 'pediatrie',  label: 'Pédiatrie',               description: 'Diarrhée sévère, malnutrition, paludisme chez l\'enfant, infections…', icone: '🩺', couleur: '#9B59B6' },
          ...
          <div>
            ...
            <div style={{ background: 'white', border: `1px solid ${VERT}30`, borderRadius: 16, padding: '24px 28px', marginBottom: 20 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
                <div style={{ width: 36, height: 36, borderRadius: 10, background: '#E8F5ED', display: 'flex', alignItems: 'center', justifyContent: 'center', color: VERT, fontSize: 18 }}>🩺</div>
