// app/profil/[id]/page.tsx — MediForm Haiti
'use client';
...
const VERT = '#1B6B45';
const ROLE_LABEL: Record<string, string> = { ADMIN: 'Administrateur', FORMATEUR: 'Formateur', APPRENANT: 'Professionnel de santé', SPECTATEUR: 'Observateur' };
    ...
    <div style={{ background: '#F8FAFB', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: 'clamp(24px,4vw,40px) clamp(20px,5vw,48px)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24 }}>
        ...
        <div style={{ background: 'white', border: '1px solid #E2E8F0', borderRadius: 14, padding: '20px 24px' }}>
          ...
          {profil.points && (
            <div style={{ background: '#E8F5ED', borderRadius: 10, padding: '12px 16px', marginBottom: 14, display: 'flex', gap: 12, alignItems: 'center' }}>
