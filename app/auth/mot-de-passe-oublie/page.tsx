// app/auth/mot-de-passe-oublie/page.tsx — TechPro Haiti
'use client';
          ...
          {!envoye ? (
            <>
              <div style={{ textAlign: 'center', marginBottom: 24 }}>
                ...
                <h2 style={{ fontFamily: 'Georgia,serif', fontSize: 22, fontWeight: 'normal', color: '#0D1B2A', margin: '0 0 8px' }}>Mot de passe oublié ?</h2>
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div>
                  ...
                  <input type="email" value={email} required onChange={e => setEmail(e.target.value)}
                    ...
                    style={{ width: '100%', padding: '13px 16px', border: `1.5px solid #CBD5E1`, borderRadius: 10, fontSize: 15, outline: 'none', fontFamily: "'Helvetica Neue',Arial,sans-serif", boxSizing: 'border-box' as const, color: '#0D1B2A', background: 'white' }}
                    onFocus={e => { e.target.style.borderColor = primaire; }}
                    onBlur={e => { e.target.style.borderColor = '#CBD5E1'; }} />
                </div>
                <button type="submit" disabled={chargement}
                  style={{ width: '100%', padding: '15px', background: chargement ? '#475569' : primaire, color: 'white', border: 'none', borderRadius: 12, fontFamily: "'Helvetica Neue',Arial,sans-serif", fontWeight: 700, fontSize: 16, cursor: chargement ? 'not-allowed' : 'pointer' }}>
            ...
            <div style={{ textAlign: 'center' }}>
              ...
              <h2 style={{ fontFamily: 'Georgia,serif', fontSize: 22, fontWeight: 'normal', color: '#0D1B2A', margin: '0 0 12px' }}>Email envoyé !</h2>
              <p style={{ fontFamily: "'Helvetica Neue',Arial,sans-serif", fontSize: 14, color: '#475569', lineHeight: 1.7, margin: '0 0 24px' }}>
              ...
              <div style={{ background: '#F0FDF4', border: '1px solid #BBF7D0', borderRadius: 10, padding: '12px 16px', marginBottom: 20 }}>
                <p style={{ fontFamily: "'Helvetica Neue',Arial,sans-serif", fontSize: 13, color: '#1E40AF', margin: 0 }}>
