// app/contact/page.tsx — MediForm Haiti
...
const CONTACTS = [
  { icone: '📧', label: 'Email', valeur: 'contact@mediformhaiti.ht', couleur: VERT },
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: 'clamp(32px,5vw,56px) clamp(20px,5vw,48px)', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, alignItems: 'start' }}>
        ...
        <div>
          ...
          {!succes ? (
            ...
            <div style={{ background: '#E8F5ED', border: '1px solid #BBF7D0', borderRadius: 16, padding: '40px', textAlign: 'center' }}>
              <div style={{ fontSize: 52, marginBottom: 14 }}>✅</div>
              <h3 style={{ fontFamily: "'Inter',sans-serif", fontSize: 20, fontWeight: 800, color: '#166534', marginBottom: 10 }}>
                Message envoyé !
              </h3>
              <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 14, color: '#166534', lineHeight: 1.6 }}>
        ...
        <div>
          ...
          <div style={{ background: `linear-gradient(135deg, ${VERT}10, ${BLEU}08)`, border: `1px solid ${VERT}25`, borderRadius: 14, padding: '20px 22px' }}>
            ...
            <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 13, color: '#64748B', lineHeight: 1.65, marginBottom: 14 }}>
              Vous représentez un hôpital, une clinique, une école de soins infirmiers ou le MSPP ? Contactez-nous pour former vos équipes avec MediForm Haiti.
            </p>
