...
const ACCUEIL: Record<string, Record<string, string>> = {
  ...
  mediform: {
    fr: "Bonjour ! Je suis l'assistant IA de MediForm Haiti. Je peux vous aider sur les soins infirmiers, les protocoles cliniques et vos formations médicales. Comment puis-je vous aider ?",
    ht: "Bonjou ! Mwen se asistan IA MediForm Haiti a. Mwen ka ede ou ak pwotokòl klinik yo ak fòmasyon medikal yo.",
    en: "Hello! I'm MediForm Haiti's AI assistant. I can help with nursing care, clinical protocols and medical training.",
  },
};
